...
var candlestick = new THREE.Mesh(
  new THREE.PlaneGeometry(86, 121),
  img_candlestick
);
...
var telepfone = new THREE.Mesh(
  new THREE.PlaneGeometry(142, 212),
  img_telepfone
);
...
var spider_web = new THREE.Mesh(
  new THREE.PlaneGeometry(92, 65),
  img_spider_web
);
